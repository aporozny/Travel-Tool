...
| R5 | places_cache uniqueness is (external_id, source) — multi-source future will create duplicates across sources | H | M | Stage 3 must add fuzzy dedup (name+100m geo) before adding Foursquare | Claude | Open (Stage 3) |
